...
CREATE SEQUENCE FLIGHTS.SEQ_AIRPLANE_ID
    INCREMENT 1
    START 1
    MINVALUE 1
...
CREATE SEQUENCE FLIGHTS.SEQ_FLIGHT_ID
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
CREATE SEQUENCE FLIGHTS.SEQ_PILOT_ID
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
-- ADDING CONSTRAINTS UNIQUE INTO FLIGHT

  ALTER TABLE FLIGHTS.FLT_AIRPLANE ADD CONSTRAINT FLT_AIRPLANE_NAME_CONSTRAINT UNIQUE (AIRPLANE_NAME);
  ALTER TABLE FLIGHTS.FLT_FLIGHT ADD CONSTRAINT FLT_FLIGHT_CODE_CONSTRAINT UNIQUE (FLIGHT_CODE);

  -- ADD COLUMNS DEPARTURE_CITY AND INTO ARRRIVAL_CITY FLIGHT

  ALTER TABLE FLIGHTS.FLT_FLIGHT ADD COLUMN DEPARTURE_CITY character varying(50);
  ALTER TABLE FLIGHTS.FLT_FLIGHT ADD COLUMN ARRRIVAL_CITY character varying(50);
